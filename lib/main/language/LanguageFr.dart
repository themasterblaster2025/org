...
class LanguageFr extends BaseLanguage {
  ...
  String get saveDraftConfirmationMsg =>
      "Êtes-vous sûr de vouloir enregistrer en tant que projet?";
  ...
  String get createOrderConfirmationMsg =>
      "Êtes-vous sûr de passer la commande?";
  ...
  String get userNotApproveMsg =>
      "Votre profil est en cours d'examen. Attendez un peu de temps ou un contact avec votre administrateur.";
  ...
  String get paymentCollectFromDelivery =>
      "Formulaire de percevoir de paiement à la livraison";

  @override
  String get paymentCollectFromPickup =>
      "Formulaire de collecte de paiement sur le ramassage";
  ...
  String get selectDeliveryTimeMsg =>
      "Veuillez sélectionner le délai de livraison";
  ...
  String get allowLocationPermission =>
      "Autoriser l'autorisation de l'emplacement";
  ...
  String get walkThrough1Subtitle =>
      "Cela nous aide à obtenir un forfait à votre porte.";

  @override
  String get walkThrough2Subtitle =>
      "Afin que nous puissions livrer rapidement le colis à la bonne personne.";
  ...
  String get passwordInvalid =>
      "La longueur minimale du mot de passe devrait être de 6";
  ...
  String get orderPickupConfirmation =>
      "Êtes-vous sûr de vouloir récupérer cette commande?";
  ...
  String get credentialNotMatch =>
      "Ces informations d'identification ne correspondent pas à nos records";
  ...
  String get notChangeMobileNo =>
      "Vous ne pouvez pas modifier le numéro de contact";
  ...
  String get confirmationCodeSent =>
      "Entrez le code de confirmation a envoyé à";
  ...
  String get demoUserNote =>
      'Remarque: la recherche d\'adresse de glisser-glisser est désactivée pour l\'utilisateur de démonstration';
  ...
  String get transactionFailed =>
      'La transaction a échoué!! Essayer à nouveau.';

  @override
  String get orderPickupSuccessfully =>
      'Félicitations !! Commandez avec succès.';

  @override
  String get orderActiveSuccessfully =>
      'Félicitations !! Commandez avec succès activé.';

  @override
  String get orderDepartedSuccessfully =>
      'Félicitations !! L\'ordre a été parti avec succès.';

  @override
  String get orderDeliveredSuccessfully =>
      'Félicitations !! La commande a été livrée avec succès.';

  @override
  String get addAmount =>
      'Le champ du montant est vide.Veuillez ajouter le montant';
  ...
  String get sureWantToDeleteDraft =>
      'Etes-vous sûr de vouloir supprimer ce brouillon de commande ?"';
  ...
  String get deliveryPersonArrivedMsg =>
      'Le livreur est arrivé au lieu de prise en charge et attend le client.';

  @override
  String get deliveryPersonPickedUpCourierMsg =>
      'Le livreur a récupéré le courrier au lieu de ramassage.';
