...
class LanguageAr extends BaseLanguage {
  @override
  String get appName => 'التوصيل العظيم';
  ...
  @override
  String get endTimeValidationMsg => 'يجب أن يكون الوقت بعد بدء العمل';
  ...
  @override
  String get parcelType => 'نوع الطرود';

  @override
  String get pickupInformation => 'معلومات التقاط';
  ...
  @override
  String get distanceCharge => 'شحنة المسافة';

  @override
  String get weightCharge => 'شحنة الوزن';
  ...
  String get saveDraftConfirmationMsg =>
      'هل أنت متأكد من أنك تريد حفظها كمسودة؟';
  ...
  @override
  String get createOrderConfirmationMsg => 'هل أنت متأكد أنك تريد تقديم الطلب؟';
  ...
  String get userNotApproveMsg =>
      'أنت ملف تعريف قيد المراجعة. انتظر بعض الوقت أو اتصل بمسؤولك.';
  ...
  @override
  String get orderDeliver => 'تسليم الطلب';

  @override
  String get orderPickup => 'طلب التقاط';

  @override
  String get info => 'معلومات';

  @override
  String get paymentCollectFromDelivery => 'نموذج جمع الدفع عند التسليم';

  @override
  String get paymentCollectFromPickup => 'نموذج جمع الدفع عند الاستلام';

  @override
  String get pickupDatetime => 'تاريخ الالتقاء والوقت';
  ...
  @override
  String get deliveryTimeSignature => 'توقيع وقت التسليم';

  @override
  String get reason => 'سبب';

  @override
  String get selectDeliveryTimeMsg => 'الرجاء تحديد وقت التسليم';

  @override
  String get orderCancelledSuccessfully => 'تم إلغاء الطلب بنجاح';

  @override
  String get trackingOrder => 'ترتيب التتبع';
  ...
  @override
  String get allowLocationPermission => 'السماح إذن الموقع';

  @override
  String get walkThrough1Title => 'حدد موقع الالتقاط';

  @override
  String get walkThrough2Title => 'حدد موقع إسقاط';

  @override
  String get walkThrough3Title => 'تأكيد واسترخ';

  @override
  String get walkThrough1Subtitle =>
      'يساعدنا في الحصول على حزمة من عتبة داركم.';

  @override
  String get walkThrough2Subtitle =>
      'حتى نتمكن من توصيل الحزمة إلى الشخص الصحيح بسرعة.';

  @override
  String get walkThrough3Subtitle =>
      'سنقوم بتسليم الحزمة الخاصة بك في الوقت المحدد وفي حالة مثالية.';
  ...
  @override
  String get courierWillDeliverAt => 'سوف تسليم البريد السريع في';
  ...
  String get orderDepartedConfirmation =>
      'هل أنت متأكد أنك تريد أن تغادر هذا الطلب؟';
  ...
  @override
  String get becomeADeliveryBoy => 'كن صبيا للتسليم';
  ...
  @override
  String get termAndCondition => 'الشروط والشرط';
  ...
  @override
  String get lastUpdateAt => 'التحديث الأخير في';
  ...
  @override
  String get damageCourier => 'الضرر البريد السريع';

  @override
  String get sentWrongCourier => 'أرسلت البريد السريع الخطأ';

  @override
  String get notAsOrder => 'ليس كطلب';
  ...
  @override
  String get deleteAccountConfirmMsg => 'هل أنت متأكد أنك تريد حذف الحساب؟';
  ...
  @override
  String get confirmPickupLocation => 'تأكيد موقع الالتقاط';
  ...
  @override
  String get bankDetails => 'التفاصيل المصرفية';
  ...
  String get cancelBeforePickMsg =>
      'تم إلغاء الطلب قبل التقاط الطرود. لذا ، يتم قطع رسوم الإلغاء فقط. إذا تم إجراء الدفع بالفعل ، فسيتم استرداد المبلغ إلى المحفظة.';
  ...
  @override
  String get selectVehicle => 'حدد مركبة';

  @override
  String get vehicleName => 'اسم السيارة';
  ...
  @override
  String get ordersWalletMore => 'الطلبات والمحفظة والمزيد';
  ...
  @override
  String get confirmationCode => 'أدخل رمز التأكيد';

  @override
  String get confirmationCodeSent => 'أدخل رمز التأكيد الذي تم إرساله إلى';

  @override
  String get getOTP => 'الحصول على OTP';

  @override
  String get weSend => 'سوف نرسل لك';

  @override
  String get oneTimePassword => 'كلمة السر لمرة واحدة';

  @override
  String get on => 'على';

  @override
  String get phoneNumberVerification => 'التحقق من رقم الهاتف';
  ...
  @override
  String get markAllRead => 'اشر عليها بانها قرات';

  @override
  String get confirmAccountDeletion => 'تأكيد حذف الحساب';

  @override
  String get signWith => 'أو تسجيل الدخول مع';

  @override
  String get selectUserType => 'حدد نوع المستخدم';

  @override
  String get lblUser => 'مستخدم';

  @override
  String get lblDeliveryBoy => 'فتى التوصيل';
  ...
  @override
  String get lblMyAddresses => 'عناويني';

  @override
  String get selectAddressSave => 'حدد العنوان من حفظ';
  ...
  @override
  String get sureWantToDeleteAddress => 'هل أنت متأكد من حذف هذا العنوان؟';
  ...
  String get demoUserNote =>
      'ملاحظة: يتم تعطيل البحث عن مكان عنوان السحب للمستخدم التجريبي';
  ...
  String get mAppDescription =>
      'يمكنك التوصيل بالضبط عندما يريد المستخدم ويمكنك البدء في معالجة طلب المستخدم فورًا تقريبًا بعد استلامه، أو يمكنك التسليم في يوم ووقت محددين.';
  ...
  String get sureWantToDeleteDraft =>
      'هل أنت متأكد أنك تريد حذف مسودة الطلب هذه؟"';
  ...
  String get deliveryPersonArrivedMsg =>
      'وصل مندوب التوصيل إلى موقع الاستلام وينتظر العميل.';

  @override
  String get deliveryPersonPickedUpCourierMsg =>
      'قام موظف التوصيل باستلام البريد السريع من موقع الاستلام.';
