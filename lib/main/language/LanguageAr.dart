...
class LanguageAr extends BaseLanguage {
  ...
  @override String get notification => "تنبيه";
  @override String get select_usertype_msg => "يرجى اختيار Usertype.";
  @override String get create_an_account => "إنشاء حساب";
  @override String get sign_up_to_continue => "اشترك للمتابعة";
  @override String get user_type => "نوع المستخدم";
  @override String get client => "عميل";
  @override String get delivery_man => "رجل التوصيل";
  @override String get already_have_an_account => "هل لديك حساب؟";
  @override String get light => "خفيفة";
  @override String get dark => "مظلم";
  @override String get system_default => "النظام الافتراضي";
  @override String get theme => "سمة";
  @override String get skip => "يتخطى";
  @override String get get_started => "البدء";

  @override String get profile => "حساب تعريفي";
  @override String get track_order_location => "تتبع طلب النظام";
  @override String get track => "مسار";
  @override String get active => "نشيط";
  @override String get pick_up => "يلتقط";
  @override String get departed => "الراحل";
  @override String get order_pickup_successfully => "طلب بيك آي بنجاح";
  @override String get image_pick_to_camera => "صورة الموافقة المسبقة عن علم إلى الكاميرا";
  @override String get image_pic_to_gallery => "صورة الموافقة المسبقة عن علم إلى المعرض";
  @override String get order_deliver => "طلب التسليم";
  @override String get order_pickup => "طلب بيك اب";
  @override String get info => "معلومات";
  @override String get payment_collect_from_delivery => "جمع الدفع النموذج عند التسليم";
  @override String get payment_collect_from_pickup => "دفع نموذج الاستمارة على بيك اب";
  @override String get pickup_datetime => "Pickup DateTime.";
  @override String get hour => "ساعة";
  @override String get delivery_datetime => "وقت التسليم";
  @override String get pickup_time_signature => "توقيع وقت الاستقبال";
  @override String get save => "يحفظ";
  @override String get clear => "صافي";
  @override String get delivery_time_signature => "وقت التسليم التوقيع";
  @override String get reason => "سبب";
  @override String get pickup_delivery => "تسليم picup";
  @override String get select_pickup_time_msg => "يرجى اختيار وقت التقاط";
  @override String get select_delivery_time_msg => "يرجى اختيار وقت التسليم";
  @override String get select_pickup_sign_msg => "يرجى توقيع picup";
  @override String get select_delivery_sign_msg => "يرجى تسليم التوقيع";
  @override String get select_reason_msg => "يرجى اختيار السبب";
  @override String get order_cancelled_successfully => "تم إلغاء الطلب بنجاح";
  @override String get collect_payment_confirmation_msg => "هل أنت متأكد من جمع هذه الدفعة؟";
  @override String get tracking_order => "تتبع النظام";

  @override String get assign => "تعيين";
  @override String get picked_up => "التقطت";
  @override String get arrived => "وصل";
  @override String get completed => "مكتمل";
  @override String get cancelled => "ألغيت";
  @override String get allow_location_permission => "السماح بإذن الموقع";
  @override String get walk_through1_title => "حدد موقع الالتقاط";
  @override String get walk_through2_title => "حدد انخفاض الموقع";
  @override String get walk_through3_title => "تأكيد والاسترخاء";
  @override String get walk_through1_subtitle => "إنها تساعدنا على الحصول على حزمة من عتبة داركم.";
  @override String get walk_through2_subtitle => "حتى نتمكن من تسليم الحزمة إلى الشخص الصحيح بسرعة.";
  @override String get walk_through3_subtitle => "سنقوم بتسليم الحزمة الخاصة بك في الوقت المحدد وفي حالة ممتازة.";
  @override String get order => "ترتيب";
  @override String get account => "حساب";
  @override String get drafts => "المسودات";
  @override String get about_us => "معلومات عنا";
  @override String get help_and_support => "ساعد لدعم";
  @override String get logout => "تسجيل خروج";
  @override String get change_location => "تغيير الموقع";
  @override String get select_city => "اختر مدينة";
