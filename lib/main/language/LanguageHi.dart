...
class LanguageHi extends BaseLanguage {
  ...
  @override
  String get deliveryNow => 'अब वितरित करें';
  ...
  @override
  String get pickupInformation => 'पिकअप सूचना';
  ...
  @override
  String get packageInformation => 'पैकेज सूचना';

  @override
  String get deliveryCharge => 'वितरण शुल्क';

  @override
  String get distanceCharge => 'दूरस्थ प्रभार';

  @override
  String get weightCharge => 'भार प्रभार';
  ...
  String get saveDraftConfirmationMsg =>
      'क्या आप सुनिश्चित हैं कि आप एक ड्राफ्ट के रूप में सहेजना चाहते हैं?';
  ...
  @override
  String get lblReturn => 'वापस करना';
  ...
  String get userNotApproveMsg =>
      'आप प्रोफ़ाइल की समीक्षा कर रहे हैं। कुछ समय प्रतीक्षा करें या अपने व्यवस्थापक से संपर्क करें।';
  ...
  @override
  String get doNotHaveAccount => 'Don \ _ का कोई खाता है?';
  ...
  @override
  String get paymentCollectFromDelivery => 'डिलीवरी पर भुगतान एकत्र करें';

  @override
  String get paymentCollectFromPickup => 'पिकअप पर भुगतान एकत्र करें';

  @override
  String get pickupDatetime => 'पिकअप की तारीख और समय';

  @override
  String get deliveryDatetime => 'डिलीवरी की तारीख और समय';
  ...
  @override
  String get selectDeliveryTimeMsg => 'कृपया डिलीवरी टाइम का चयन करें';

  @override
  String get orderCancelledSuccessfully => 'आदेश सफलतापूर्वक रद्द कर दिया गया';

  @override
  String get trackingOrder => 'ट्रैकिंग ऑर्डर';
  ...
  @override
  String get allowLocationPermission => 'स्थान की अनुमति दें';

  @override
  String get walkThrough1Title => 'पिकअप स्थान का चयन करें';

  @override
  String get walkThrough2Title => 'ड्रॉप लोकेशन का चयन करें';
  ...
  String get walkThrough1Subtitle =>
      'यह हमें अपने दरवाजे से पैकेज प्राप्त करने में मदद करता है।';
  ...
  String get areYouSureWantToArrive =>
      'क्या आप सुनिश्चित हैं कि आप आना चाहते हैं?';
  ...
  @override
  String get courierWillDeliverAt => 'कूरियर पर डिलीवर होगा';
  ...
  String get orderPickupConfirmation =>
      'क्या आप सुनिश्चित हैं कि आप इस आदेश को चुनना चाहते हैं?';

  @override
  String get orderDepartedConfirmation =>
      'क्या आप सुनिश्चित हैं कि आप इस आदेश को छोड़ देना चाहते हैं?';

  @override
  String get orderCreateConfirmation =>
      'क्या आप सुनिश्चित हैं कि आप यह आदेश बनाना चाहते हैं?';

  @override
  String get orderCompleteConfirmation =>
      'क्या आप सुनिश्चित हैं कि आप इस आदेश को पूरा करना चाहते हैं?';
  ...
  @override
  String get becomeADeliveryBoy => 'एक डिलीवरी बॉय बनें';
  ...
  @override
  String get lastUpdateAt => 'पर अंतिम अद्यतन';
  ...
  @override
  String get onDelivery => 'डिलीवरी पर';
  ...
  @override
  String get deliveredTo => 'बितरण किया:';
  ...
  @override
  String get placeOrderByMistake => 'गलती से ऑर्डर करें';
  ...
  @override
  String get changeOrder => 'आदेश बदलो';
  ...
  String get cancelAfterPickMsg =>
      'पार्सल को पिकअप के बाद ऑर्डर रद्द कर दिया गया था। पूरी तरह से चार्ज कट गया।';

  @override
  String get cancelNote =>
      'नोट: यदि आप पार्सल पिकअप से पहले ऑर्डर रद्द करते हैं तो रद्द करने का शुल्क काट दिया जाएगा।';
  ...
  @override
  String get selectVehicle => 'वाहन का चयन करें';
  ...
  @override
  String get ordersWalletMore => 'आदेश, बटुआ और बहुत कुछ';
  ...
  @override
  String get confirmationCode => 'पुष्टि कोड दर्ज करें';

  @override
  String get confirmationCodeSent => 'पुष्टिकरण कोड दर्ज करें।';

  @override
  String get getOTP => 'OTP प्राप्त करें';

  @override
  String get weSend => 'हम आपको भेज देंगे';

  @override
  String get oneTimePassword => 'एक बारी पासवर्ड';

  @override
  String get on => 'पर';

  @override
  String get phoneNumberVerification => 'फ़ोन नंबर सत्यापन';
  ...
  @override
  String get confirmAccountDeletion => 'खाता विलोपन की पुष्टि करें';

  @override
  String get signWith => 'या के साथ साइन इन करें';

  @override
  String get selectUserType => 'उपयोगकर्ता प्रकार का चयन करें';

  @override
  String get lblUser => 'उपयोगकर्ता';

  @override
  String get lblDeliveryBoy => 'वितरण करने वाला लड़का';
  ...
  @override
  String get lblMyAddresses => 'मेरे पते';

  @override
  String get selectAddressSave => 'सहेजें से पता चुनें';

  @override
  String get selectAddress => 'पता चुनें';

  @override
  String get deleteLocation => 'स्थान हटाएं?';

  @override
  String get sureWantToDeleteAddress =>
      'क्या आप निश्चित रूप से इस पते को हटाना चाहते हैं?';
  ...
  String get demoUserNote =>
      'नोट: ड्रैग-ड्रॉप पता स्थान खोज डेमो उपयोगकर्ता के लिए अक्षम है';
  ...
  String get orderDepartedSuccessfully =>
      'बधाई हो !! आदेश को सफलतापूर्वक छोड़ दिया गया है।';

  @override
  String get orderDeliveredSuccessfully =>
      'बधाई हो !! आदेश सफलतापूर्वक दिया गया है।';
  ...
  String get orderAssignConfirmation =>
      'क्या आप वाकई यह आदेश स्वीकार करना चाहते हैं?';
  ...
  String get sureWantToDeleteDraft =>
      'क्या आप वाकई इस ड्राफ्ट ऑर्डर को हटाना चाहते हैं?"';
  ...
  String get deliveryPersonArrivedMsg =>
      'डिलीवरी व्यक्ति पिक-अप स्थान पर आ गया है और ग्राहक की प्रतीक्षा कर रहा है।';

  @override
  String get deliveryPersonPickedUpCourierMsg =>
      'डिलीवरी व्यक्ति ने पिकअप स्थान से कूरियर उठाया है।';
  ...
  String get paymentStatusPaisMsg =>
      'भुगतान की स्थिति का भुगतान कर दिया गया है।';
