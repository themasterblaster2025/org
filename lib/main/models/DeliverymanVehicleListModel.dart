...
class VehicleInfo {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "registration_date": registrationAte != null ? "${registrationAte!.year.toString().padLeft(4, '0')}-${registrationAte!.month.toString().padLeft(2, '0')}-${registrationAte!.day.toString().padLeft(2, '0')}" : "",
