          ...
          children: [
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ).visible((weightCharge != 0 || distanceCharge != 0) && widget.orderData.extraCharges.keys.length != 0),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      16.height,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text('$currencySymbol ${widget.orderData.totalAmount}', style: boldTextStyle(size: 18, color: colorPrimary)),
                    ],
                  ),
                ],
              ),
            ...
            Align(
              ...
              child: commonButton('Return Order', () {
                ReturnOrderScreen(widget.orderData).launch(context);
              }, width: context.width())
                  .paddingAll(16),
            ).visible(widget.orderData.status == ORDER_COMPLETED)
          ],
        ),
      ),
    );
