                  ...
                  if(selectedIndex == 3)
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            scheduleOptionWidget(isCashPayment, 'assets/icons/ic_clock.png', 'Cash').onTap(() {
                              isCashPayment = true;
                              setState(() {});
                            }).expand(),
                            16.width,
                            scheduleOptionWidget(!isCashPayment, 'assets/icons/ic_schedule.png', 'Credit Card').onTap(() {
                              isCashPayment = false;
                              setState(() {});
                            }).expand(),
                          ],
